...
public class Book {
	...
	public Book(String id, String name, String author, float price, int salesamount, int storenumber,
			String imagepath, String categorysid) {
		super();
		this.id = id;
		this.name = name;
		this.author = author;
	...
	public String toString() {
		return "Book [id=" + id + ", name=" + name + ", author=" + author + ", price=" + price
				+ ", salesamount=" + salesamount + ", storenumber=" + storenumber + ", imagepath="
				+ imagepath + ", categorysid=" + categorysid + "]";
	}
